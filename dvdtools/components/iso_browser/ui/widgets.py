...
def create_widgets(parent: Any) -> None:
    ...
    parent.dump_all_titles_button = PushButton(
        "Dump Entire Disc", parent, clicked=parent.ffmpeg_handler.dump_all_titles
    )
    ...
    parent.info_button.clicked.connect(
        lambda: QDesktopServices.openUrl(
            QUrl("https://jaded-encoding-thaumaturgy.github.io/JET-guide/master/sources/dvd/remuxing/")
        )
    )
